...
/**
 * The {@code Vertex} class represents a vertex in a hypergraph or in a conflict
 * graph. Each vertex is characterized by a unique identifier and a weight. The
 * identifier is used to distinguish between different vertices, while the
 * weight represent the energy consumption.
 */
public class Vertex {
  private String id;
  ...
  /**
   * Returns a string representation of the vertex. The string representation
   * consists of the vertex's identifier and weight, enclosed in curly braces.
   *
